...
# Add the path to the current directory to ensure imports work
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

# We'll define the minimum needed classes and functions from MAIN2.PY
# This avoids the complex import issues

# Define ClaimStatus enum
...
# Import process_claim function from MAIN2.PY
from main2 import process_claim
...
# Inside the run_web_interface function, update the image handling code:
    if submit_button and policy_number and uploaded_file:
        ...
        if image.mode == 'RGBA':
            ...
            # Paste the RGBA image on the RGB image using the alpha channel
...
# Run the web interface when the script is executed directly
